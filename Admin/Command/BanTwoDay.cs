...
namespace BotCore
{
	internal class BanTwoDay : AbsCommand, IStandartCommand, ISplitName
	{
		public override System.String Name { set; get; } = CommandText.BanTwoDay;
		...
		{
			IStandartCommand standartCommand = new BanTwoDay();
			ISplitName splitName = new BanTwoDay();
