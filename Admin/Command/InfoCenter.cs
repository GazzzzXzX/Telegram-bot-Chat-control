...
namespace BotCore
{
	internal class InfoCenter : Advertising.Command.AbsCommand, IStandartCommand
	{
		public override System.String Name { set; get; } = CommandText.InfoCenter;
		...
		{
			IStandartCommand standartCommand = new InfoCenter();
