...
namespace BotCore
{
	internal class AddPictureNotification : AbsCommand, IStandartCommand
	{
		public override System.String Name { set; get; } = CommandText.AddPictureNotification;
		...
		{
			user.Chain = (Int32)SetChain.PictureNotification;
			db.Save();
		}
