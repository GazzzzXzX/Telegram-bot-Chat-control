...
{
	public class SetPriceStandartMessage: AbstractHandlerAdvertising, IStandartCommand
	{
		...
		{
			if (request == (System.Int32)SetChain.SetPriceStandartMessage)
			{
		...
		private void ChangePrice()
		{
			...
			AdController.PriceData.postTypeDefault = price;
