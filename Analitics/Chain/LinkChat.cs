...
namespace BotCore
{
	internal class LinkChat : AbstractHandlerAdvertising
	{
		...
		{
			if (request == (System.Int32)SetChain.LinkChat)
			{
				...
				PrintExel.GetAnaliticsInOneChatWord(analyticsTexts, channel, botClient, _message, user);
