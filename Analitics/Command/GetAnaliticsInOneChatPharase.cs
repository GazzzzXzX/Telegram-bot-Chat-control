...
{
	internal class GetAnaliticsInOneChatPharase : Advertising.Command.AbsCommand, IStandartCommand
	{
		public override System.String Name { set; get; } = PhotoCommandName.GetAnaliticsInOneChatPharase;
		...
		{
			user.Chain = (Int32)SetChain.LinkChatPharase;
			db.Save();
		}
	}
}
