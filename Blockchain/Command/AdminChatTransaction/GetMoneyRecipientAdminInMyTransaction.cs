...
{
	/// <summary>
	/// Класс отвечающий за отправление денег получателю!
	/// </summary>
	internal class GetMoneyRecipientAdminInMyTransaction : Advertising.Command.AbsCommand, IStandartCommand, ITransaction, ISplitName
	{
		public override System.String Name { set; get; } = CommandTextBlockchain.GetMoneyRecipientAdminInMyTransaction;
		...
		public void SendMessage(TelegramBotClient botClient)
		{
			...
			text += $"Администратор @{user.Username} принял принял решение отправить деньги получателю!";
		...
		public void SetUser() => userAdmin = db.GetUser(Convert.ToInt32(Name.Split(" ")[2]));
